...
///ligas para resaltar en la relacion entre pilares
function muestraEnPlot(leyenda,datos,prefijo){
	var links = "<span class= 'txt_12em'>"+leyenda+":</span><span> &emsp; -";
	for(var i=0; i<datos.length; i++){
		links = links + '<a href="javascript:dibujaplots('+ "'" + datos[i][1] +  "'" + ",'" + prefijo +  "'" + ')">'+datos[i][2]+'</a>- &emsp;'
	};
	links = links + "</span> ";
	return links;
};
...
function dibujaplots(clave,prefijo){
	var nivel = "R";
	if (clave.length==2){
		var nivel = "E";
	}
	...
	if (nivel === "E"){
		...
		agregaSelec(prefijo + 'relPil0',5,6,clave,nivel,rowse,diamcol);
		agregaSelec(prefijo + 'relPil1',5,7,clave,nivel,rowse,diamcol);
		agregaSelec(prefijo + 'relPil2',5,8,clave,nivel,rowse,diamcol);
		agregaSelec(prefijo + 'relPil3',6,7,clave,nivel,rowse,diamcol);
		agregaSelec(prefijo + 'relPil4',6,8,clave,nivel,rowse,diamcol);
		agregaSelec(prefijo + 'relPil5',7,8,clave,nivel,rowse,diamcol);
